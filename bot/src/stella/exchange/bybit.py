...
ccxt経由でBybit APIに接続し、BaseExchangeインターフェースを実装する。
テストネットモードおよびペーパートレードモードに対応。
"""
...
class BybitExchange(BaseExchange):
    ...
    ccxt.bybitを使用してBybit APIと通信する。
    リトライ機構、レートリミット、テストネット/ペーパートレード対応を含む。
    """
